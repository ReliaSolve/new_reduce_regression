...
for f in $files; do
  ...
  (mmtbx.probe2 excluded_bond_chain_length=4 ignore_lack_of_explicit_hydrogens=True outputs/$base.orig.pdb output.filename=outputs/$base.orig.kin output.overwrite=True > outputs/$base.orig.probe2.kin.stdout 2> outputs/$base.orig.probe2.kin.stderr) &
  (mmtbx.probe2 excluded_bond_chain_length=4 ignore_lack_of_explicit_hydrogens=True outputs/$base.new.pdb output.filename=outputs/$base.new.kin output.overwrite=True > outputs/$base.new.probe2.kin.stdout 2> outputs/$base.new.probe2.kin.stderr) &
  ...
  (mmtbx.probe2 excluded_bond_chain_length=4 ignore_lack_of_explicit_hydrogens=True outputs/$base.orig.pdb output.filename=outputs/$base.orig.txt output.overwrite=True output.count_dots=True > outputs/$base.orig.probe2.stdout 2> outputs/$base.orig.probe2.stderr) &
  (mmtbx.probe2 excluded_bond_chain_length=4 ignore_lack_of_explicit_hydrogens=True outputs/$base.new.pdb output.filename=outputs/$base.new.txt output.overwrite=True output.count_dots=True > outputs/$base.new.probe2.stdout 2> outputs/$base.new.probe2.stderr) &
  wait
